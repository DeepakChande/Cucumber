...
public class HomePage extends BasePage {
	...
	By dropdown = By.xpath("(//*[@class=\"nav-icon arrow-down-icon\"])[9]");
	By loggedInUserName = By.xpath("(//*[@class=\"navAccount-accountName\"])[1]");
	...
	public String isUSerLoggedIn() {
		elementActions.waitForElementPresent(dropdown);
		elementActions.doClick(dropdown);
