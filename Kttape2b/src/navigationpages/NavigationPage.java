...
public class NavigationPage {
	...
	public Account navigatetoaccountpage(WebDriver driver) {
		Account objaccountpage = new Account();
		PageFactory.initElements(driver, objaccountpage);
		return objaccountpage;
	}
